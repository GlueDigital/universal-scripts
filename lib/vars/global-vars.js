...
const usedVariablesWithoutValues = extractUsedEnvVariables()
const variablesWithValues = Object.fromEntries(
  Object.entries(process.env).filter(([key]) => usedVariablesWithoutValues.includes(key))
)

export const globalVariables = variablesWithValues
